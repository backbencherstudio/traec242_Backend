                                ...
                                <tr>
                                    <td style="padding:44px 48px 40px;">
                                        ...
                                        <p style="margin:0 0 36px;font-size:15px;color:#6b7280;text-align:center;line-height:1.7;">
                                            Enter the one-time code below to complete your verification.<br>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" style="background-color:#FFF3CD;border-left:4px solid #FF6B2C;border-radius:8px;padding:14px 20px;">
                                                    <p style="margin:0;font-size:13px;color:#7c4a00;text-align:left;">
                                                        ⏱&nbsp; This code is valid for <strong>10 minutes</strong> only. Request a new one if it expires.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
